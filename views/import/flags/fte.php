    ...
    <div class="section">
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <div>
                    <form method="post" action="<?php echo URL; ?>import/runflags/fte">
                                ...
                                <tbody>
                                    ...
                                    foreach( $_SESSION['flaggedmemberinfo'] as $members ): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="member[<?php echo $i; ?>][member_id]" id="existingmembers<?php echo $i; ?>">
                                                    <option value="0" disabled>Select an existing member</option>
