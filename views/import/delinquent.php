    ...
    <div class="section">
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <div>
                    <form method="post" action="<?php echo URL; ?>import/rundelinquents">
                        <div class="right">
                            ...
                            if( !empty($this->delinquentmem) ):
                                foreach( $this->delinquentmem as $members ): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" name="member[<?= $i; ?>][action]" value="official" id="official<?= $i; ?>" >
                                            <label for="official<?= $i; ?>">Union Official</label>
                                            <input type="radio" name="member[<?= $i; ?>][action]" value="delinquent" id="delinquent<?= $i; ?>" checked>
