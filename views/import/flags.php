                            ...
                            <table>
                                ...
                                foreach( $_SESSION['flaggedmemberinfo'] as $members ): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="member[<?php echo $i; ?>][member_id]">
                                                ...
                                                <?php foreach( $this->currentmembers as $current ): ?>
                                                    <option value="<?= $current['id'] ?>" <?= ($members['employee_id'] == $current['company_id']) ? 'selected' : ''; ?>><?= $current['firstname'].' '.$current['lastname'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </td>
                                        ...
                                        <input type="hidden" name="member[<?php echo $i; ?>][note]" value="<?= $members['note']; ?>" />
                                        <input type="hidden" name="member[<?php echo $i; ?>][employee_id]" value="<?= $members['employee_id']; ?>" />
                                        <?php foreach( $members['dues'] as $week => $dues ): ?>
                                            <input type="hidden" name="member[<?php echo $i; ?>][dues][<?= $week ?>][date]" value="<?= $dues['date']; ?>" />
                                            <input type="hidden" name="member[<?php echo $i; ?>][dues][<?= $week ?>][dues]" value="<?= $dues['dues']; ?>" />
                                        <?php endforeach; ?>
                                    </tr>
                                    <?php $i++;
                                endforeach; ?>
