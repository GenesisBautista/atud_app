    ...
    <div class="section">
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <div>
                    <form method="post" action="<?php echo URL; ?>import/rundelinquents/aci">
                        <div class="right">
                            ...
                            if( !empty($this->delinquentmem) ):
                                foreach( $this->delinquentmem as $members ): ?>
                                    <tr>
                                        ...
                                        <td><input type="radio" name="member[<?= $i; ?>][action]" value="delinquent" >Delinquent this month</td>
                                        <td><input type="radio" name="member[<?= $i; ?>][action]" value="deactivate" >Deactivate member</td>
